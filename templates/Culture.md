...
- **Localização:** (Litoral, montanhas, planícies, subterrâneo).
- **Clima:** Como o clima afeta as roupas e a arquitetura?
- **Recursos Abundantes:** (O que eles têm de sobra? Madeira? Ouro? Água?)
- **Recursos Escassos:** (Pelo que eles matariam ou fariam comércio para obter?)

### 3. Estrutura Social

- **Hierarquia:** Quem manda? (Reis, Sacerdotes, Mercadores, os mais velhos, os mais fortes?).
- **Unidade Familiar:** Como as famílias se organizam? (Nuclear, clãs gigantes, poligamia, comunal, crianças criadas pelo estado?).
- **Papéis de Gênero/Classe:** Existe igualdade? Existem castas rígidas ou mobilidade social?
- **Tratamento de Forasteiros:** Eles são hospitaleiros, xenofóbicos ou indiferentes?
